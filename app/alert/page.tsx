...
export default function AlertPage() {
  ...
  return <main className={styles.page}>
    <header className={styles.header}>
      ...
      <nav className={styles.nav}><a href="#rozwiazania">Rozwiązania</a><a href="#technologie">Technologie</a><a href="#realizacje">Realizacje</a><a href="#strategia">Strategia</a><a href="#kontakt">Kontakt</a></nav>
    ...
    <section className={styles.aiSection}>
      ...
      <div className={styles.aiCopy}><span className={styles.kicker}>03 · ALERT AI SECURITY ARCHITECT</span><h2>Opisz obiekt. <em>Engine buduje architekturę.</em></h2><p>Cyfrowy doradca ALERT przyjmuje opis obiektu, istniejące systemy i problem. Engine tworzy profil ryzyka, zakres technologii, priorytety i pytania dla inżyniera.</p><div className={styles.aiSteps}>{["Profil obiektu","Mapa ryzyka","Security Stack","Plan modernizacji"].map((x,i)=><div key={x}><span>0{i+1}</span><b>{x}</b><ChevronRight size={14}/></div>)}</div><a className={styles.primary} href="#audyt">Uruchom koncepcję audytu <ArrowRight size={16}/></a></div>
    </section>

    <section id="audyt" className={styles.auditSection}>
      <div className={styles.auditCopy}><span className={styles.kicker}>04 · DIGITAL LEAD ENGINE</span><h2>Security Audit <em>przed pierwszym telefonem.</em></h2><p>Interaktywny formularz kwalifikuje obiekt i tworzy wstępny brief dla zespołu ALERT. W wersji produkcyjnej dane trafiają do Core Engine, a każda rekomendacja otrzymuje dowód, priorytet i następny krok.</p><div className={styles.auditPills}><span>Risk profile</span><span>Technology gaps</span><span>Modernization</span><span>Priority 1–3</span></div></div>
